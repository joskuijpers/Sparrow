...
public class SceneCoding {
    ...
    public func save(entities: [Entity], in world: World, to path: URL, generator: String = "SparrowEngine", origin: String? = nil) throws {
        ...
        var file = SPSFile(header: SPSFileHeader(generator: generator, origin: origin), nexus: nexusBytes)
        file.updateChecksum()
...
fileprivate struct SPSFile: Codable {
    ...
    init(header: SPSFileHeader, nexus: [UInt8]) {
        self.header = header
        self.nexus = nexus
    }
}
...
extension SPSFile {
    ...
    private func generateChecksum() -> UInt {
        ...
        for b in nexus.prefix(through: 10) {
