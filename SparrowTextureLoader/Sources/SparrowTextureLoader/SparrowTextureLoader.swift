...
public class SparrowTextureLoader {
...
//        case tga
    ...
    public func load(from url: URL) throws -> MTLTexture {
        // Get from cache
...
//        }
        ...
        let texture = try buildTexture(with: descriptor)
...
//                                  (pixelFormat >= MTLPixelFormatEAC_R11Unorm && pixelFormat <= MTLPixelFormatETC2_RGB8A1_sRGB);
    ...
    private func buildTexture(with descriptor: TextureDescriptor) throws -> MTLTexture {
